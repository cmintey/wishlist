...
<div class="flex flex-col space-y-4 {vertical ? 'items-center' : 'md:flex-row md:items-end md:space-y-0 md:space-x-4'}">
    ...
    {#if url}
        <div
            class="flex flex-col space-y-2 {vertical
                ? 'items-center'
                : 'md:flex-row md:items-center md:space-y-0 md:space-x-2'}"
            out:fade
        >
